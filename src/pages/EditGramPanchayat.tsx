  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        toast({
          title: "Error",
          description: response.message || "Failed to update Gram Panchayat.",
          variant: "destructive",
        });
      }
    } catch (error: any) {
      toast({
        title: "Error",
        description: error?.message || "Failed to update Gram Panchayat.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    <div className="p-6 bg-background min-h-screen">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="space-y-4">
          ...
          <h1 className="text-3xl font-bold text-foreground">Edit Gram Panchayat</h1>
        </div>
        {/* Form */}
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-center gap-4 max-w-md mx-auto pt-4">
            ...
            <Button type="submit" disabled={loading}>
              {loading ? 'Updating...' : 'Update Gram Panchayat'}
            </Button>
          </div>
        </form>
      </div>
...
export default EditGramPanchayat;